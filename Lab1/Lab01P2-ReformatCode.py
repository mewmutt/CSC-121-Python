#Edited by Myles Joubert on 1/5/22
# Jane Student
# May 19, 2021
...
def main():
    ...
    for i in range(number_plays):
        ...
        print(
            f"Game {i+1}: {choices[user_choice]} vs. {choices[computer_choice]} - ",
            end="",
        )
...
def get_number_plays():
    ...
    while True:
        try:
            number_plays = int(input("How many times for computer to choose (1-50): "))
